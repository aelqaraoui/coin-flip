  ...
  switch (env) {
    ...
    case 'local':
      return {
        ...
        keyPath: "".concat("/home/amine", "/.near/validator_key.json"),
...
function _signedInFlow() {
  _signedInFlow = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
    var accountLink, contractLink, balance, near, account, provider, urlSearchParams, params, result;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            accountLink = document.querySelector('[data-behavior=notification] a:nth-of-type(1)');
            accountLink.href = accountLink.href + window.accountId;
            accountLink.innerText = '@' + window.accountId;
            contractLink = document.querySelector('[data-behavior=notification] a:nth-of-type(2)');
          ...
          case 12:
            _context2.t0 = _context2.sent.available;
            balance = _context2.t0 / 1000000000000000000000000;
            document.querySelector('#balance').innerText += "Balance : " + balance.toFixed(2);
            _context2.next = 17;
            return connect(window.walletConnection._near.config);

          case 17:
            near = _context2.sent;
            _context2.next = 20;
            return near.account(window.walletConnection._near.config.contractName);
          ...
          case 23:
            ...
            console.log(params);
            _context2.next = 32;
            return provider.txStatus(params, window.walletConnection._near.config.contractName);
